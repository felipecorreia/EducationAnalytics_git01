...
class PainelsControllerTest < ActionController::TestCase
  ...
  test "should create painel" do
    assert_difference('Painel.count') do
      post :create, painel: { nome_app: @painel.nome_app, qtd_evento: @painel.qtd_evento, tipo_evento: @painel.tipo_evento }
    end
  ...
  test "should update painel" do
    patch :update, id: @painel, painel: { nome_app: @painel.nome_app, qtd_evento: @painel.qtd_evento, tipo_evento: @painel.tipo_evento }
    assert_redirected_to painel_path(assigns(:painel))
  end
